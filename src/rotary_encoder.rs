...
pub static RENCODER: Mutex<RefCell<Option<Encoder<Pin<'A', 0, Input>, Pin<'A', 1, Input>>>>> =
    Mutex::new(RefCell::new(None));
pub static GENCODER: Mutex<RefCell<Option<Encoder<Pin<'A', 2, Input>, Pin<'A', 3, Input>>>>> =
    Mutex::new(RefCell::new(None));
pub static BENCODER: Mutex<RefCell<Option<Encoder<Pin<'A', 4, Input>, Pin<'A', 5, Input>>>>> =
    Mutex::new(RefCell::new(None));
